    ...
    const contactMethods = [
        {
            ...
            ,
            contact: "christianlife_academy@yahoo.com"
        },
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        },
        {
            ...
            ,
            contact: "Breman West, Kumasi, Ghana"
        },
    ]
            ...
            <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
                <div className="max-w-lg mx-auto gap-12 justify-between lg:flex lg:max-w-none">
                    <div className="max-w-lg space-y-3">
                        ...
                        <p>
                            For all quesitons relating to admissions. Please reach out by filling out the form, or use any of the contact information below .
                        </p>
                        <div>
                    ...
                    <div className="flex-1 mt-12 sm:max-w-lg lg:max-w-md">
                        {isSubmitted ? (
                        <div className='text-5xl font-semibold text-green-500'>Message submitted succesfully</div>
                        ) 
                        : 
                        (
                        <form
